    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          ...
          var suggestion = data.firstWhere((element) => element.id == categoryId);
          return Row(
            children: [
              Expanded(flex: 5, child: Amount(20.0, suggestion.userAverage, "Your average spending")),
              Expanded(flex: 1, child: VerticalDivider(thickness: 1.0,)),
              Expanded(flex: 5, child: Amount(20.0, suggestion.allAverage, "Suggested spending"))
            ],
          );
        }
